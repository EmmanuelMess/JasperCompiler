...
struct MetaUnifier {
	...
	[[nodiscard]] Tag tag(int idx) const;
	[[nodiscard]] bool is_dot_target(int idx) const;

	[[nodiscard]] bool is(int idx, Tag t) const;
	[[nodiscard]] bool is_singleton_var(int idx) const;
	[[nodiscard]] bool is_constant(Tag tag) const;
	[[nodiscard]] bool is_constant(int idx) const;
